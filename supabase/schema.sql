...
create table if not exists public.service_requests (
  ...
  request_intent text check (request_intent in ('NEW_METER', 'UPSCALE', 'RELOCATE', 'PHASE_UPGRADE', 'EXPANSION')),
  ...
  krabi_reference_no text,
  krabi_submitted_at timestamptz,
  krabi_submitted_by uuid,
  manager_return_reason text,
