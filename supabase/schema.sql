...
create table if not exists public.service_requests (
  ...
  status text not null default 'NEW' check (status in ('NEW', 'PENDING_SURVEY_REVIEW', 'SURVEY_ACCEPTED', 'SURVEY_DOCS_INCOMPLETE', 'SURVEY_RESCHEDULE_REQUESTED', 'SURVEY_COMPLETED', 'WAIT_DOCUMENT_REVIEW', 'WAIT_DOCUMENT_FOLLOWUP', 'WAIT_BILLING', 'WAIT_ACTION_CONFIRMATION', 'WAIT_MANAGER_REVIEW', 'COMPLETED')),
  survey_note text,
